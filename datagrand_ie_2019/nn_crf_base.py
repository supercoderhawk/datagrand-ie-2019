...
from .data_loader import NeuralSeqDataLoader
from .nn_crf_vocab import NeuralSeqVocab
from .utils.constant import BATCH_PAD, BOS, EOS, UNK, FIT, INFERENCE
...
class NeuralNetworkCRFBase(object):
    ...
    def __init__(self, *, mode: str, config: NeuralNetworkCRFConfig):
        ...
        if self.mode == FIT:
            self.data = NeuralSeqDataLoader(filename=self.config.training_filename,
